...
已经能在训练好的 TinyLM checkpoint 上跑通全 fixed-order batch-invariant smoke test；
...
| 模型级 Batch Invariance 解决 | 已有参考实现 | fixed-tree RMSNorm、fixed-tile Linear/Matmul 与 `flash_attn_2_bi` 已接入 TinyLM |
